...
void MPDevice::uploadBundle(QString filePath, const MessageHandlerCb &cb)
{
    ...
    jobs->append(new MPCommandJob(this, MPCmd::CMD_DBG_ERASE_DATA_FLASH, pMesProt->getDefaultFuncDone()));

    jobs->append(new MPCommandJob(this, MPCmd::CMD_DBG_IS_DATA_FLASH_READY,
...
void MPDevice::checkDataFlash(const QByteArray &data, QElapsedTimer *timer, AsyncJobs *jobs, QString filePath)
{
    ...
    else
    {
        ...
        jobs->prepend(new MPCommandJob(this, MPCmd::CMD_DBG_IS_DATA_FLASH_READY,
                       [this, timer, jobs, filePath](const QByteArray &data, bool &) -> bool
                       {
                           checkDataFlash(data, timer, jobs, filePath);
                           return true;
...
void MPDevice::sendBundleToDevice(QString filePath, AsyncJobs *jobs)
{
    QFile file(filePath);
    ...
    for (const auto byte : blob)
    {
        ...
        if (260 == byteCounter)
        {
            jobs->append(new MPCommandJob(this, MPCmd::CMD_DBG_DATAFLASH_WRITE_256B, message,
    ...
    jobs->append(new MPCommandJob(this, MPCmd::CMD_DBG_REINDEX_BUNDLE, pMesProt->getDefaultFuncDone()));
}
